            ...
            {isOpen && (
                ...
                >
                    <div className="flex items-center justify-between pb-3 border-b border-white/10 mb-4">
                        <span className="text-[11px] font-black font-mono text-[var(--cyan)] flex items-center gap-2">
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full h-1 bg-white/10 rounded-full appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-3 [&::-webkit-slider-thumb]:h-3 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-[var(--cyan)] hover:[&::-webkit-slider-thumb]:scale-125 transition-all"
                            />
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full h-1 bg-white/10 rounded-full appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-3 [&::-webkit-slider-thumb]:h-3 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-[var(--plasma-green)] hover:[&::-webkit-slider-thumb]:scale-125 transition-all"
                            />
                        </div>

                        <div className="text-[8px] text-[var(--executive-gold)] text-center pt-2 font-mono uppercase tracking-widest opacity-60 border-t border-white/5 mt-2">
