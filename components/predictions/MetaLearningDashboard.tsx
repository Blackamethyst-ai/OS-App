            ...
            {activeView === 'insights' && (
                ...
                >
                    ...
                    <div className="p-6 bg-white/5 border border-white/10 rounded-lg">
                        ...
                        <div className="space-y-3">
                            {[
                                { label: 'Session Outcomes', weight: 50, color: 'bg-purple-500' },
                                { label: 'Cognitive State', weight: 30, color: 'bg-blue-500' },
                                { label: 'Research Availability', weight: 15, color: 'bg-cyan-500' },
