...
const CompactMetric = ({ title, value, detail, icon: Icon, color, trend }: any) => (
    <div className="bg-black/40 border border-white/5 rounded-2xl p-4 flex flex-col gap-2 hover:border-white/15 transition-all group shadow-inner relative overflow-hidden">
...
const SwarmBox = () => {
    ...
    return (
        <div className="bg-[var(--bg-card-top)] border border-[var(--border-main)] rounded-[2.5rem] p-6 flex flex-col gap-4 shadow-2xl relative overflow-hidden group/swarm shrink-0">
            ...
            <div className="flex items-center justify-between px-1 relative z-10">
                <div className="flex items-center gap-3">
                    <Hexagon size={14} className="text-[#9d4edd] animate-pulse" />
                    <span className="text-[9px] font-black font-mono text-white uppercase tracking-[0.4em]">Swarm Matrix</span>
                </div>
                <div className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-[#10b981] shadow-[0_0_8px_#10b981]" />
                    <span className="text-[7px] font-mono text-gray-600 uppercase tracking-widest">v4.0</span>
                </div>
            </div>
                ...
                {Array.from({ length: hexCount }).map((_, i) => {
                    ...
                    return (
                        <div key={i} className={cn(
                            "aspect-square flex flex-col items-center justify-center rounded-2xl border transition-all duration-700 shadow-inner",
                            isActive 
                                ? "bg-black/40 border-[#9d4edd]/30 shadow-[0_0_15px_rgba(157,78,221,0.1)]" 
