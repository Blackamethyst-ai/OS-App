                ...
                <>
                    ...
                    >
                        ...
                        <div className="grid grid-cols-7 gap-4 p-6 bg-black/20 border-b border-white/5">
                            {[
                                { label: 'Friction Signals', value: stats.totalFrictionSignals, icon: AlertTriangle, color: 'var(--amber)' },
                                { label: 'Hypotheses', value: stats.totalHypotheses, icon: GitBranch, color: 'var(--amethyst-soft)' },
                                { label: 'Pending', value: stats.pendingEvolutions, icon: Zap, color: 'var(--cyan)' },
                                { label: 'Approved', value: stats.approvedEvolutions, icon: Check, color: 'var(--plasma-green)' },
                                { label: 'Ready to Deploy', value: (stats as any).pendingDeployments || 0, icon: Cpu, color: '#f43f5e' },
                                { label: 'Deployed', value: stats.deployedEvolutions, icon: Activity, color: 'var(--azure-blue)' },
