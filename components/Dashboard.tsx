...
const ExecutiveBanner = () => {
    ...
    return (
        <div className="w-full crystalline rounded-3xl p-10 mb-8 relative overflow-hidden group">
            <div className="absolute inset-0 bg-gradient-to-br from-white/[0.03] to-transparent opacity-40" />
            ...
            <div className="relative z-10 flex items-center gap-12">
                <div className="flex flex-col items-center gap-3 shrink-0">
                    <div className="relative w-32 h-32 flex items-center justify-center">
                        ...
                        <div className={cn(
                            ...
                            voice.isActive ? "border-[#f1c21b] shadow-[0_0_25px_rgba(241,194,27,0.3)] scale-105" : "border-white/10"
                        )}>
                ...
                <div className="flex-1 flex flex-col gap-1.5">
                    <div className="flex items-center gap-5 mb-2">
                        <div className="flex items-center gap-2.5 px-4 py-1.5 glass-action rounded-full border-white/10">
                ...
                <div className="flex flex-col items-end gap-8 shrink-0 px-8 border-l border-white/10">
...
const MetricCard = ({ title, value, detail, icon: Icon, color, data, trend }: any) => (
    <div className="crystalline rounded-[2rem] p-6 h-36 flex flex-col justify-between transition-all hover:border-white/40 group relative overflow-hidden">
        <div className="flex justify-between items-start relative z-10">
            <div className="flex items-center gap-4">
                <div className="p-2.5 rounded-2xl glass-action text-gray-400 group-hover:text-white transition-all border-white/10">
        ...
        <div className="flex items-end justify-between relative z-10">
            ...
            <div className="h-16 w-32 opacity-20 group-hover:opacity-60 transition-opacity">
      ...
      <div className="max-w-[2200px] mx-auto w-full space-y-10 pb-28">
          ...
          <div className="grid grid-cols-12 gap-10">
              ...
              <div className="col-span-7 h-[950px] flex flex-col">
                  <div className="flex-1 crystalline rounded-[4rem] overflow-hidden relative group flex flex-col">
                      <div className="h-20 border-b border-white/10 flex items-center justify-between px-12 bg-white/[0.02] shrink-0 z-20">
                      ...
                      <div className="h-28 bg-black/10 backdrop-blur-3xl border-t border-white/10 flex items-center justify-between px-12 shrink-0 z-20">
                         <div className="flex gap-6">
              ...
              <div className="col-span-2 space-y-8 flex flex-col">
                  <div className="crystalline rounded-[3rem] p-8 h-[280px] shadow-2xl relative overflow-hidden">
                  ...
                  <div className="crystalline rounded-[3rem] p-8 h-[260px] shadow-2xl flex flex-col gap-5 relative overflow-hidden">
                      <div className="flex items-center justify-between mb-2 relative z-10">
                         ...
                         <label className="cursor-pointer p-2 glass-action rounded-2xl transition-all border-white/10 group/label">
                      ...
                      <div className="flex-1 bg-black/10 rounded-[2.5rem] border border-white/10 flex items-center justify-center overflow-hidden relative group/anchor shadow-inner z-10">
                          {dashboard.referenceImage ? (
                                ...
                                <label className="flex flex-col items-center gap-4 cursor-pointer p-8 group/label">
                                    <div className="p-6 rounded-[2rem] glass-action border border-white/10 group-hover/label:border-[#f1c21b] transition-all">
                  ...
                  <div className="flex-1 crystalline rounded-[3rem] p-10 flex flex-col gap-8 shadow-2xl relative overflow-hidden">
                      <div className="flex items-center gap-4 text-[#10b981] relative z-10">
                          <DollarSign size={24} />
                      ...
                      <div className="space-y-8 flex-1 flex flex-col justify-center relative z-10">
                          {[
                              ...
                              <div key={cat.label} className="space-y-4">
                                  ...
                                  <div className="h-2 w-full bg-white/5 rounded-full overflow-hidden border border-white/5 p-px shadow-inner">
