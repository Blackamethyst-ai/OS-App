            ...
            <div className="grid grid-cols-3 gap-6 px-4">
                ...
                >
                    ...
                    <div className={cn(
                        ...
                        stats.avgDQScore >= 0.7 ? "text-[#10b981]" :
                        stats.avgDQScore >= 0.5 ? "text-[#f59e0b]" : "text-[#ef4444]"
                    )}>
                ...
                >
                    ...
                    <div className="text-4xl font-black text-[#22d3ee] font-mono">{stats.avgRoundsToConverge.toFixed(1)}</div>
    ...
    <div className="max-w-4xl mx-auto space-y-12 pb-24">
        <div className="flex items-center justify-between px-4">
            ...
            <div className="flex gap-4">
                ...
                />
                <button onClick={onAddTask} className="p-3 bg-[#9d4edd] text-black rounded-2xl hover:scale-105 active:scale-95 transition-all shadow-xl" aria-label="Add task"><Plus size={20} /></button>
            </div>
        </div>
    ...
    <div className="w-[320px] border-r border-white/5 flex flex-col shrink-0 bg-black/20 z-10">
        <div className="p-6 border-b border-white/5 bg-white/[0.01]">
            <span className="text-[11px] font-black text-gray-500 uppercase tracking-[0.4em] flex items-center gap-3 px-1">
                <Code size={14} className="text-[#9d4edd]" /> Operational Nodes
            </span>
        </div>
                    ...
                    <div className="flex justify-between items-start">
                        <div className="flex items-center gap-4">
                            <div className={cn(
                                ...
                                selectedId === agent.id ? "bg-[#9d4edd]/20 border-[#9d4edd]/40 text-[#9d4edd] shadow-[0_0_15px_rgba(157,78,221,0.2)]" : "bg-black/40 border-white/10 text-gray-600"
                            )}>
