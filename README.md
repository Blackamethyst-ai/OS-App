...
<p align="center">
  <img src="https://img.shields.io/badge/Lines-132,000+-00d9ff?style=for-the-badge" alt="Lines" />
  <img src="https://img.shields.io/badge/Files-494+-4a0080?style=for-the-badge" alt="Files" />
  <img src="https://img.shields.io/badge/Version-1.5.0-00d9ff?style=for-the-badge" alt="Version" />
...
See [Security Audit](SECURITY_AUDIT_PROMPT_EXTRACTION.md) for the full threat model.
...
- [x] ~~Organisms Framework (Genome + Swarm + Cognitive)~~ (v1.5)
- [x] ~~MCP Integration (client + wire server)~~ (v1.5)
- [x] ~~Capabilities Registry Consolidation~~ (v1.5)
- [x] ~~CPB Routing Migration~~ (v1.5)
- [x] ~~Prompt Isolation Security~~ (v1.5)
...
| [Organisms Framework](#9-organisms-framework-servicesorganisms) | Genome + Swarm + Cognitive layers |
| [Security Audit](SECURITY_AUDIT_PROMPT_EXTRACTION.md) | Prompt extraction threat model and mitigations |
...
| [Capabilities README](services/capabilities/README.md) | Full API reference for 110+ capabilities |
